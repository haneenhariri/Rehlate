...
export default function Hero() {
  ...
  return (
    <section className="bg-[url(/hero.jpg)] overflow-hidden p-5 text-white text-center bg-cover bg-center font-lama flex justify-center items-center min-h-screen">
        ...
        <div className="w-[30px] h-[30px] flex justify-center items-center rounded-full bg-white">
            <img src={img} alt="arrow"  className='ltr:rotate-180 w-auto h-auto'/>
        </div>
        <img src={img2} className=' w-auto h-auto sm:-left-24 -left-5 sm:top-12 top-24 absolute ' alt="" />
        </div>
